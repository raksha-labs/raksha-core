...
use common::{connect_postgres_client, init_logging, start_health_check_server, ShutdownSignal};
use dotenvy::dotenv;
...
async fn sync_simlab_catalog(
    ...
    for file in scenario_files {
        ...
        let default_speed = scenario_obj
            ...
            .unwrap_or(10)
            .max(1);
        let default_speed = i32::try_from(default_speed).with_context(|| {
            format!("default_speed for scenario '{scenario_id}' exceeds i32 range")
        })?;
