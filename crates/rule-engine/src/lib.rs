...
use core_interfaces::RuleEvaluator;
...
fn chain_matches(
    rule_chain: &str,
    event_chain: &common_types::Chain,
...
mod tests {
    use super::*;
    use common_types::{Chain, EventStatus, NormalizedEvent, ProtocolCategory};
    ...
    fn mk_event(
        ...
        NormalizedEvent {
            ...
            lifecycle_state: common_types::LifecycleState::Provisional,
