...
VALUES
    (
        ...
        12,
        ARRAY['flash_loan', 'depeg'],
        ARRAY['tx_hash', 'price', 'amount', 'slippage_bps'],
        2,
        '[{"pattern_id":"flash_loan","severity":"high"},{"pattern_id":"depeg","severity":"medium"}]'::jsonb,
    ...
    (
        ...
        8,
        ARRAY['depeg', 'tvl_drop'],
        ARRAY['price', 'slippage_bps', 'market'],
        1,
        '[{"pattern_id":"depeg","severity":"critical"}]'::jsonb,
